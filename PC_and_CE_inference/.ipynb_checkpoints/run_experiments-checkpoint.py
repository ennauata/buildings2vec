...
res_dir = '/home/nelson/Workspace/building_reconstruction/working_model/wireframe/result/junc/3/15/2'
...
for _id in _ids:
    ...
    # draw annotations
    dwg = svgwrite.Drawing('../result/svg_regions/{}_7.svg'.format(_id), (128, 128))
    ...
    dwg = svgwrite.Drawing('../result/svg_regions/{}_0.svg'.format(_id), (128, 128))
    #dwg.add(svgwrite.image.Image(im_path, size=(128, 128)))
    im_path = os.path.join(rgb_dir, _id + '.jpg')
    ...
    dwg = svgwrite.Drawing('../result/svg_regions/{}_1.svg'.format(_id), (128, 128))
    #dwg.add(svgwrite.image.Image(im_path, size=(128, 128)))
    im_path = os.path.join(rgb_dir, _id + '.jpg')
    draw_building(dwg, junctions, juncs_on, lines_on)
    dwg.save()
    ...
    dwg = svgwrite.Drawing('../result/svg_regions/{}_2.svg'.format(_id), (128, 128))
    #dwg.add(svgwrite.image.Image(im_path, size=(128, 128)))
    im_path = os.path.join(rgb_dir, _id + '.jpg')
    draw_building(dwg, junctions, juncs_on, lines_on)
    dwg.save()
    ...
    dwg = svgwrite.Drawing('../result/svg_regions/{}_3.svg'.format(_id), (128, 128))
    #dwg.add(svgwrite.image.Image(im_path, size=(128, 128)))
    im_path = os.path.join(rgb_dir, _id + '.jpg')
    draw_building(dwg, junctions, juncs_on, lines_on)
    dwg.save()
    ...
    dwg = svgwrite.Drawing('../result/svg_regions/{}_4.svg'.format(_id), (128, 128))
    ...
    deb.save('./regions/{}.jpg'.format(_id))
    dwg = svgwrite.Drawing('../result/svg_regions/{}_5.svg'.format(_id), (128, 128))
    dwg.add(svgwrite.image.Image(os.path.abspath('./regions/{}.jpg'.format(_id)), size=(128, 128)))
    im_path = os.path.join(rgb_dir, _id + '.jpg')
    draw_building(dwg, junctions, juncs_on, lines_on)
    dwg.save()
   ...
   ################### EXPERIMENT VI ####################
    ...
    deb.save('./regions/{}.jpg'.format(_id))
    dwg = svgwrite.Drawing('../result/svg_regions/{}_6.svg'.format(_id), (128, 128))
    dwg.add(svgwrite.image.Image(os.path.abspath('./regions/{}.jpg'.format(_id)), size=(128, 128)))
    im_path = os.path.join(rgb_dir, _id + '.jpg')
    draw_building(dwg, junctions, juncs_on, lines_on)
    dwg.save()
