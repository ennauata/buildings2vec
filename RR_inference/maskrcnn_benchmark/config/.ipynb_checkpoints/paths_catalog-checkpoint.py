...
#             "img_dir": "/local-scratch2/nnauata/cities_dataset/rgb",
#             "ann_file": "/local-scratch2/nnauata/cities_dataset/annot",
#             "id_file": "/local-scratch2/nnauata/cities_dataset/valid_list.txt",
#             "split": "test"
#         }
        "buildings_train": {
            "img_dir": "/local-scratch2/nnauata/cities_dataset/rgb",
    ...
    def get(name):
        if "coco" in name:
            ...
            args = dict(
                ...
                ann_file=os.path.join(data_dir, attrs["ann_file"]),
                id_file=os.path.join(data_dir, attrs["id_file"]),
                split=attrs["split"]
            )
            if attrs["split"] == 'train':
                return dict(
                    factory="BuildingsDataset",
                    args=args,
                )
            else:
                return dict(
                    factory="BuildingsDatasetTest",
                    args=args,
                )
