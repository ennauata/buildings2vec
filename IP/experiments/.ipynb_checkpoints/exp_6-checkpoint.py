...
# Experiment VI - Enforcing boundaries between adjacent regions
def run_experiment_6(cs, cs_c, edge_map, th, th_c, metric, graph_annot, region_mks, shared_edges, rgb_dir, _id):
...
_id=_id)
	...
	# FOR TEASER
	graph = {'junctions':junctions, 'juncs_on':juncs_on, 'lines_on':lines_on}
	np.save('../results/vectors_for_teaser/{}.npy'.format(_id), graph, 'bytes')
	# FOR TEASER
	...
	# Draw output image
	dwg = svgwrite.Drawing('../results/for_teaser/{}_6.svg'.format(_id), (128, 128))
